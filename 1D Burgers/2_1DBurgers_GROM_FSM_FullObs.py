# -*- coding: utf-8 -*-
"""
FSM estimation of global eddy viscosity parameter from full field measurements 
...
z = PODproj(uObs- um.reshape(-1,1),Phi).T
...
plt.plot(x,uFOM[:,0], label=r'$t=0.00$',linewidth=3)
plt.plot(x,uFOM[:,25], label=r'$t=0.25$',linewidth=3)
plt.plot(x,uFOM[:,50], label=r'$t=0.50$',linewidth=3)
plt.plot(x,uFOM[:,75], label=r'$t=0.75$',linewidth=3)
plt.plot(x,uFOM[:,100], label=r'$t=1.00$',linewidth=3)
plt.xlabel(r'$x$', fontsize = 26)
plt.ylabel(r'$u(x,t)$', fontsize=26)
plt.legend(loc="center", bbox_to_anchor=(0.5,1.15), ncol=3, fontsize=22, handletextpad=0.4 ,columnspacing=1)
plt.savefig('./Plots/fig1.png', dpi = 500, bbox_inches = 'tight')
plt.show()

#%% Figure 2

plt.figure(figsize=(8,6))
plt.plot(x,uObs[:,0], label=r'$t=0.25$',linewidth=2)
plt.plot(x,uObs[:,1], label=r'$t=0.50$',linewidth=2)
plt.xlabel(r'$x$', fontsize=26)
plt.ylabel(r'$u(x,t)$', fontsize=26)
plt.legend(loc="center", bbox_to_anchor=(0.4,0.2), ncol=1, fontsize=22, handletextpad=0.4 ,columnspacing=1)
plt.ylim([-0.5,1.5])
plt.savefig('./Plots/fig2.png', dpi = 500, bbox_inches = 'tight')
plt.show()
...
plt.savefig('./Plots/fig3.png', dpi = 500, bbox_inches = 'tight')
fig.show()
...
plt.savefig('./Plots/fig4.png', dpi = 500, bbox_inches = 'tight')
